...
class ObjectViewed(models.Model):
	...
	object_id = models.PositiveIntegerField() #User_id, Product_id, Order_id
	...
	class Meta:
		ordering = ['-timestamp'] #most recent saved show up
		verbose_name = 'Object viewed'
		verbose_name_plural = 'Object viewed'

def object_viewed_receiver(sender, instance,request,*args, **kwargs):
	c_type = ContentType.objects.get_for_model(sender) #instance .__class__ e.g. ObjectViewed
	# print(sender)
	# print(instance)
	# print(request)
	# print(request.user)	
